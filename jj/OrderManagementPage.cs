...
namespace TechfixClientApp
{
    public partial class OrderManagementPage : Form
    {
        ...
        public OrderManagementPage(int supplierId)
        {
            InitializeComponent();
            this.Text = "Orders Management - Supplier - TechFix Solutions";
            techFixService = new TechFixWebServicesSoapClient();
            this.supplierId = supplierId;
            LoadDefaults();
            this.FormClosing += OrderManagement_FormClosing;
        ...
        void LoadDefaults()
        {
            ...
            List<Order> orders = techFixService.GetAllOrders()?.Where(q => q.supplierId == supplierId).ToList();
